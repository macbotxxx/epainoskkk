...
MIGRATION_MODULES = {"sites": "epainos.contrib.sites.migrations"}
...
ADMINS = [("""Michael Assanama""", "admin@epainos.com")]
...
ACCOUNT_FORMS = {"signup": "epainos.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "epainos.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "epainos.users.forms.UserSocialSignupForm"}
